...
export default function AdminReportsScreen() {
  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.title}>Reportes Globales</Text>
      {[
        { label: 'Usuarios nuevos por mes', icon: 'user-plus' },
        { label: 'Centros activos', icon: 'briefcase' },
        { label: 'Transacciones QR', icon: 'credit-card' },
        { label: 'Ingresos de comisiones', icon: 'trending-up' },
      ].map((r, i) => (
